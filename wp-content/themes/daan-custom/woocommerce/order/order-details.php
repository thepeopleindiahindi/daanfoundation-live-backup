...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<thead>
			<tr>
				<th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Cause', 'woocommerce' ); ?></th>
		...
		<tbody>
			...
			foreach ( $order_items as $item_id => $item ) {
				// Fee items (donations) have no get_product() method — guard against the fatal error.
		...
		<tfoot>
			...
			foreach ( $order->get_order_item_totals() as $key => $total ) {
				// Fee (donation) rows already show as their own line in the item table above — skip the footer duplicate.
				if ( isset( $total['type'] ) && 'fee' === $total['type'] ) {
					continue;
				}
				?>
					<tr>
